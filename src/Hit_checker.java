...
public class Hit_checker {
  ...
  public boolean check_player_bullet_collision(Bullet current_bullet, Enemy enemy){
    return current_bullet.get_x() < enemy.get_x() + enemy.get_width() &&
        current_bullet.get_x() + current_bullet.get_width() > enemy.get_x() &&
        current_bullet.get_y() < enemy.get_y() + enemy.get_height() &&
        current_bullet.get_y() + current_bullet.get_height() > enemy.get_y();
  }
}
